...
exports.LockError = exports.LOCK_PRESETS = exports.LockManager = void 0;
exports.initLockManager = initLockManager;
...
var LockError;
(function (LockError) {
    LockError["ACQUISITION_TIMEOUT"] = "LOCK_ACQUISITION_TIMEOUT";
    LockError["EXECUTION_ERROR"] = "LOCK_EXECUTION_ERROR";
    LockError["EXTENSION_FAILED"] = "LOCK_EXTENSION_FAILED";
    LockError["RELEASE_FAILED"] = "LOCK_RELEASE_FAILED"; // Lock release failed (orphaned)
})(LockError || (exports.LockError = LockError = {}));
/**
...
exports.LOCK_PRESETS = LOCK_PRESETS;
/**
...
class LockManager {
    ...
    constructor(redisClients) {
        ...
        this.redlock = new redlock_1.default(redisClients, settings);
     ...
     * ```
     */
    async withLock(lockKey, fn, config = LOCK_PRESETS.STANDARD) {
        let lock = null;
 ...
 */
function initLockManager(redisClients) {

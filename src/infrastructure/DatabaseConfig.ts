...
interface ContainerResources {
  ...
  /** Node.js libuv thread pool size */
 ...
 */
function getContainerResources(): ContainerResources {
 ...
 */
export function calculateDirectLimit(): number {
 ...
 * ```
 */
export function generateDatabaseConfig(): DatabaseConfig {
  const poolSize = calculatePoolSize();

...
exports.DealerBrain = void 0;
const events_1 = require("events");
class DealerBrain extends events_1.EventEmitter {
    personality;
    emotionalState;
    difficultyLevel; // 0-1, affects strategy variations
    constructor(personalityPreset = 'PROFESSIONAL') {
        super();
        this.personality = this.loadPersonality(personalityPreset);
        this.emotionalState = 'neutral';
        this.difficultyLevel = 0.5;
    }
    loadPersonality(preset) {
        const personalities = {
            PROFESSIONAL: {
     ...
     */
    adjustDifficulty(playerWinRate) {
     ...
     */
    recommendAction(playerHand, dealerUpCard, gameType) {
    ...
    recommendBlackjackAction(playerHand, dealerUpCard) {
...
exports.DealerBrain = DealerBrain;
//# sourceMappingURL=DealerBrain.js.map